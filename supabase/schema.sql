...
create table if not exists projects (
  ...
  project_mode text check (project_mode in ('maintenance', 'repair', 'upgrade', 'restoration', 'diagnostic')),
  plan_type text default 'phase_plan' check (plan_type in ('checklist', 'repair_plan', 'upgrade_plan', 'phase_plan', 'diagnostic_log')),
  condition text,
  intake_summary text,
